...
class ConfigureApp extends StatefulWidget {
  @override
  _ConfigureAppState createState() => _ConfigureAppState();
}
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              Text(
                TextConstants.configureText,
                style: ItrisTextStyles.bodyTextMulti,
              ),
              SizedBox(height: 40),
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: UnderlineInputBorder(
                    borderSide:
                        BorderSide(color: Palette.lightGrey, width: 0.6),
                  ),
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: RaisedButton(
              ...
              child: Text('Connect', style: ItrisTextStyles.bigButtonCaption),
            ),
          ),
        ),
      ),
